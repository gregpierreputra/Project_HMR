...
class DataModule(pl.LightningDataModule):
    ...
    _hmr_training_data_base_path = '/home/greg/Monash_MDN_Projects/HMR_Train_Data'
    _hmr_eval_data_base_path = '/home/greg/Monash_MDN_Projects/HMR_Val_Data'
    ...
    _mpi_inf_train_wds_url = os.path.join(_hmr_training_data_base_path, "mpi-inf-train-pruned/{000000..00006}.tar")
    ...
    _cmu_mocap_train_wds_url = os.path.join(_hmr_training_data_base_path, "cmu_mocap.npz")

    # Validation dataset
    _coco_val_wds_url = os.path.join(_hmr_eval_data_base_path, "coco-val/{000000..000000}.tar")
    ...
    def setup(self, stage: Optional[str] = None) -> None:
        ...
        if (self.training_dataset == None):
            self.training_dataset = load_web_dataset(self._mpi_inf_train_wds_url).with_epoch(self._test_epoch_value).shuffle(self._test_shuffle_value)
    ...
    def train_dataloader(self) -> DataLoader:
        ...
        motion_capture_dataloader = DataLoader(self.motion_capture_dataset, self.training_mocap_batch_size, shuffle=True, drop_last=True, num_workers=self.training_number_of_workers)
