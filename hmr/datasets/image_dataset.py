...
class ImageDataset(Dataset):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        num_pose = 3 * (smpl_num_body_joints + 1)
        ...
        self.rot_aug_rate = ROT_AUG_RATE
        self.do_flip = DO_FLIP
        self.flip_aug_rate = FLIP_AUG_RATE
        self.extreme_crop_aug_rate = EXTREME_CROP_AUG_RATE
        self.extreme_crop_aug_level = EXTREME_CROP_AUG_LEVEL
    ...
    def __getitem__(self, idx: int) -> Dict:
        ...
        (
            ...
            ROT_AUG_RATE=self.rot_aug_rate,
            DO_FLIP=self.do_flip,
            FLIP_AUG_RATE=self.flip_aug_rate,
            EXTREME_CROP_AUG_RATE=self.extreme_crop_aug_rate,
            EXTREME_CROP_AUG_LEVEL=self.extreme_crop_aug_level,
        )
